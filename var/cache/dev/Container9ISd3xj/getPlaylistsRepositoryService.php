 ...
 */
class getPlaylistsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlaylistsRepository' shared autowired service.
     *
     * @return \App\Repository\PlaylistsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlaylistsRepository.php';

        return $container->privates['App\\Repository\\PlaylistsRepository'] = new \App\Repository\PlaylistsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
