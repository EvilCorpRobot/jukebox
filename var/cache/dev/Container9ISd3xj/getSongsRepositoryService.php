 ...
 */
class getSongsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SongsRepository' shared autowired service.
     *
     * @return \App\Repository\SongsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SongsRepository.php';

        return $container->privates['App\\Repository\\SongsRepository'] = new \App\Repository\SongsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
